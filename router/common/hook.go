...
func HookBuild(applyId int) []*command.TaskResult {
	apply := &deploy.Apply{
		ID: applyId,
	}
...
func hookCommandTaskRun(s string, applyId int) []*command.TaskResult {
